		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Indicator",
									"targetURL": "#zetpmindicator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zetpmindicator-display": {
								"semanticObject": "zetpmindicator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zetpmindicator",
									"url": sap.ui.require.toUrl("zetpmindicator")
								}
							}
						}
					}
